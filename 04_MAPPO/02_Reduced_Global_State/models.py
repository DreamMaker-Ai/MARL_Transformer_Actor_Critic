...
class MarlTransformerModel(tf.keras.models.Model):
    ...
    :inputs: padded obs (None,n,g,g,ch*n_frames), n=max_num_agents
             mask (None,n,n)
    :return: [policy_probs, global_value]: [(None,n,action_dim), (None,1)]
    ...
    ==================================================================================================
     ...
     multi_head_attention_model (Mu  ((None, 15, 256),   526080      ['cnn_model[0][0]']
     ...
     value_model (ValueModel)       (None, 1)            3147009     ['cnn_model[0][0]']

    ==================================================================================================
    Total params: 4,853,638
    Trainable params: 4,853,638
    ...
    def call(self, x, mask, training=True):
        ...
        """ Values """
        global_value = self.value(features_cnn, training=training)  # (None,1)

        return [policy_probs, global_value], [score1, score2]
    ...
    def sample_actions(self, states, mask, training=False):
        ...
        [policy_probs, _], scores = self(states, mask, training=training)
