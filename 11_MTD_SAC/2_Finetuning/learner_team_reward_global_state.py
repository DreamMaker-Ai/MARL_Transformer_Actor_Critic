...
class Learner:
    ...
    def update_network(self, minibatchs):
        ...
        for minibatch in minibatchs:
            ...
            agent_obs, agent_action, agent_reward, agent_next_obs, agent_done, \
            team_r, team_done, agent_mask, agent_next_mask, global_state, next_global_state = \
                experiences2per_agent_list(self, minibatch)
            ...
            global_states, next_global_states = \
                per_agent_list2input_list(self, agent_obs, agent_action, agent_reward,
                                          agent_next_obs, agent_done, team_r, team_done, agent_mask,
                                          agent_next_mask, global_state, next_global_state)
