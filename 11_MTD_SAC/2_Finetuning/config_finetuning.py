...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/model_66000/'  # newest file -> 'ls -ltr'
        # self.model_dir = None

        self.alpha_dir = 'models/alpha_66000.npy'  # logalpha
        # self.alpha_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 66000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
