...
class Tester:
    ...
    def reset_states(self, observations, global_state):
        ...
        # For agents in Env
             ...
             self.frames[red.id]: deque[(grid_size,grid_size,channels),...], len=n_frames

             -> transform to observatios
             self.padded_obs: [(1,grid_size,grid_size,channels*n_frames),...], len=n
...
def main(is_debug):
    ...
    masks = make_mask(alive_agents_ids, max_num_agents)  # [(1,1,n),...],len=n, bool
