...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/model_40000/'  # newest file -> 'ls -ltr'
        # self.model_dir = None

        self.alpha_dir = 'models/alpha_40000.npy'  # logalpha
        # self.alpha_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 40000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
        ...
        self.learning_rate = 1e-5  # Default=5e-5
