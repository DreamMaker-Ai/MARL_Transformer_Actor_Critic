...
from sub_models_global_state_mtc_dec_pomdp_blue import CNNModel, MultiHeadAttentionModel, PolicyModel, \
...
class MarlTransformerGlobalStateModel(tf.keras.models.Model):
    ...
    def sample_actions(self, x, mask, attention_mask, training=False):
        ...
        num_agents = self.config.max_num_blue_agents
        actions = []
...
def main():
    from battlefield_strategy_test_scenario import BattleFieldStrategy  # used in main
