...
class Config:
    def __init__(self):
        ...
        """ blues_model_for test (reds model is defined in tester) """
        self.pool_of_test_blue_networks = [0, 100000, 440000, 500000, 1000000, 1530000]
        self.blue_id = 500000 # id for test
        ...
        """ Define scenario 1-9:grid_15 & max_steps=100, 10-13:grid_50 & max_steps=400 """
        self.scenario_id = 1
