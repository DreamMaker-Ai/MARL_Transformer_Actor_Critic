...
class Config:
    def __init__(self):
        ...
        # self.model_dir = 'reds_model_17/model_440000/'  # newest file -> 'ls -ltr'
        # self.model_dir = 'models/model_1115000/'  # newest file -> 'ls -ltr'
        self.model_dir = None

        # self.alpha_dir = 'reds_model_17/alpha_440000.npy'  # logalpha
        # self.alpha_dir = 'models/alpha_1115000.npy'  # logalpha
        self.alpha_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 1115000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
        ...
        """ Define scenario 1-9:grid_15, 10-13:grid_50 """
        self.scenario_id = 13
