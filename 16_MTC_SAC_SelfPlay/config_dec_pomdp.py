...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/model_1120000/'  # newest file -> 'ls -ltr'
        # self.model_dir = None

        # self.alpha_dir = 'reds_model/alpha_440000.npy'  # logalpha
        self.alpha_dir = 'models/alpha_1120000.npy'  # logalpha
        # self.alpha_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 1120000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
