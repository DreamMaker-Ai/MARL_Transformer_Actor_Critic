...
@ray.remote
class Worker:
    def __init__(self, pid, pool_of_networks):
        """
        batch_size=t_max
        """
        self.pid = pid
    ...
    def rollout_and_collect_trajectory(self, weights, pool_of_networks):
        """
        ...
        trajectory = self._rollout(pool_of_networks)

        return trajectory

    def _rollout(self, pool_of_networks):
        """
