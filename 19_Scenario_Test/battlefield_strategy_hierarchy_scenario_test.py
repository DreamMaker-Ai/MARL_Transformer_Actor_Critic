...
from generate_agents_in_env_test_scenario import generate_red_team, generate_blue_team
...
from models_hierarchy_blue import MarlTransformerHierarchyModel
...
class BattleFieldStrategy(gym.Env):
    ...
    def build_blue_policy(self):  # copied from tester.main(), then modified.
        ...
        # """ Use the followings for build blues neural net
        # Load model
