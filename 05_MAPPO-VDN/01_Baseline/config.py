...
class Config:
    def __init__(self):
        ...
        # self.model_dir = 'models/global_policy_20700/'  # newest file -> 'ls -ltr'
        self.model_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 20700  # learner update cycles. Should be read from tensorboard
        ...
        self.update_batch_size = self.batch_size * 6  # learner minibatch_size, 6=num_workers
        self.opt_iter = 5  # learner update iters per an update_cycle
        self.clip_range = 0.2  # clip range of PPO policy and value
        self.clip_by_global_norm = 10.0  # clip of gradient, default=0.5
